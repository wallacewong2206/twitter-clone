...
export default function AuthPage() {
    ...
    const url = "https://9ba3b3f4-cd00-4e5a-ae08-3ca8db15bd5d-00-3n99o0iki4p3m.janeway.replit.dev";
        ...
        <Row>
            ...
            <Col sm={6} className="p-4">
                ...
                <Col sm={5} className="d-grid gap-2">
                    ...
                    <Button
                        className="rounded-pill" onClick={handleShowSignUp}>Create an account</Button>
                ...
                <Modal
                        ...
                        <p style={{ fontSize: "12px" }}>
                            By signing up, you agree to the Terms of Service and Privacy Policy, including Cookie Use. SigmaTweets may use your contact information, including your email address and phone number for purpose outlined in our Privacy Policy, like keep  your account secure and personalising our service, including ads. Learn more, Others will be able to find you by email or phone number, when provided, unless you choose otherwise here.
                        </p>
